...
config.sdir_libs_dir = os.path.join(config.sdir_obj_root, "lib")

config.substitutions.append(("%sdir_libs", config.sdir_libs_dir))
...
llvm_config.with_environment(
    "PYTHONPATH",
    [
        os.path.join(config.mlir_obj_dir, "python_packages", "sdir"),
    ],
    append_path=True,
)
